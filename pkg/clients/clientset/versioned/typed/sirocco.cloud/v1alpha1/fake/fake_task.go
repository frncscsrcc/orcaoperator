...
var tasksResource = schema.GroupVersionResource{Group: "sirocco.cloud", Version: "v1alpha1", Resource: "tasks"}

var tasksKind = schema.GroupVersionKind{Group: "sirocco.cloud", Version: "v1alpha1", Kind: "Task"}
...
func (c *FakeTasks) UpdateStatus(task *v1alpha1.Task) (*v1alpha1.Task, error) {
	obj, err := c.Fake.
