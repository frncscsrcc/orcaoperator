...
type Interface interface {
	// Ignitors returns a IgnitorInformer.
	Ignitors() IgnitorInformer
...
// Ignitors returns a IgnitorInformer.
func (v *version) Ignitors() IgnitorInformer {
	return &ignitorInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
